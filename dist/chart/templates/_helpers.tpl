...
*/}}
{{- define "getoffyoursaas.fullname" -}}
...
*/}}
{{- define "getoffyoursaas.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "getoffyoursaas.resourceName" -}}
{{- $fullname := include "getoffyoursaas.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "getoffyoursaas.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enabled | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "getoffyoursaas.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
